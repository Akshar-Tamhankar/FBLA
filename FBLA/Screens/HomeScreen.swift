...
private struct GhostCapsuleButton: View {
    ...
    var body: some View {
        Button(action: action) {
            ...
            // Keep brand color, but this still reads fine in dark mode because it's outline style.
...
struct HomeScreen: View {
    ...
    var body: some View {
        ScrollView {
            VStack(spacing: 16) {
                // HERO / BRAND — frosted (default via .cardStyle below)
                Card {
                    VStack(alignment: .leading, spacing: 10) {
                        HStack(spacing: 12) {
                            ...
                            VStack(alignment: .leading, spacing: 2) {
                                // Use .primary so it adapts to Light/Dark
                        ...
                        // Use .primary so title adapts to theme
                ...
                // DASHBOARD — keep surface for contrast + info density
                Card(dense: true) {
        ...
        // Make all cards frosted by default on this screen
        .cardStyle(.frosted)
        // Let the 3D background shine through for blur; navigation bar stays readable.
